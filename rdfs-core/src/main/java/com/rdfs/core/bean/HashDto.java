...
public class HashDto extends HashMap<String, Object> implements Dto {
	...
	private static Logger log = LoggerFactory.getLogger(HashDto.class);
	...
	public Integer getInteger(String pKey) {
		Object obj = TypeConvertFactory.convert(get(pKey), "Integer", null);
		if (obj != null)
			return (Integer) obj;
		else
			return null;
	...
	public Long getLong(String pKey) {
		Object obj = TypeConvertFactory.convert(get(pKey), "Long", null);
		if (obj != null)
			return (Long) obj;
		else
			return null;
	...
	public String getString(String pKey) {
		Object obj = TypeConvertFactory.convert(get(pKey), "String", null);
		if (obj != null)
			return (String) obj;
		else
			return "";
	...
	public BigDecimal getBigDecimal(String pKey) {
		Object obj = TypeConvertFactory.convert(get(pKey), "BigDecimal", null);
		if (obj != null)
	...
	public Date getDate(String pKey) {
		Object obj = TypeConvertFactory.convert(get(pKey), "Date", "yyyy-MM-dd");
		if (obj != null)
			return (Date) obj;
		else
			return null;
	...
	public Timestamp getTimestamp(String pKey) {
		Object obj = TypeConvertFactory.convert(get(pKey), "Timestamp", "yyyy-MM-dd HH:mm:ss");
		if (obj != null)
	...
	public Boolean getBoolean(String pKey) {
		Object obj = TypeConvertFactory.convert(get(pKey), "Boolean", null);
		if (obj != null)
			return (Boolean) obj;
		else
			return null;
	...
	public String getOrder() {
		return getString(Constants.ORDER_KEY);
	}
