...
public class RdfsUtils {
	...
	private static Logger log = LoggerFactory.getLogger(RdfsUtils.class);
	...
	public static Date getDate() {
		Object obj = TypeConvertFactory.convert(getDateStr(), "Date", "yyyy-MM-dd");
		if (obj != null)
			return (Date) obj;
		else
			return null;
	...
	public static Timestamp getDateTime() {
		Object obj = TypeConvertFactory.convert(getDateTimeStr(), "Timestamp", "yyyy-MM-dd HH:mm:ss");
		if (obj != null)
	...
	public static Date stringToDate(String strDate) {
		Date tmpDate = (new SimpleDateFormat(Constants.DATATIME)).parse(strDate, new ParsePosition(0));
		if (tmpDate == null) {
			tmpDate = (new SimpleDateFormat(Constants.DATA)).parse(strDate, new ParsePosition(0));
		}
		return tmpDate;
	}
	...
	public static String getIeVersion(String userAgent) {
		String ieVersion = "";
		if (isIE(userAgent)) {
			userAgent = RdfsUtils.trimAll(userAgent);
