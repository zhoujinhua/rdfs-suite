			...
			var g = {
				...
				parseDate : function(n, w, q, u) {
					if (n instanceof Date) {
						var y = new Date(n.valueOf() - n.getTimezoneOffset()
								* 60000);
						y.setMilliseconds(0);
						return y
					}
					...
					if (/^[-+]\d+[dmwy]([\s,]+[-+]\d+[dmwy])*$/.test(n)) {
						...
						for ( var p = 0; p < o.length; p++) {
							...
							case "d":
								...
								break;
							case "m":
								n = i.prototype.moveMonth.call(i.prototype, n,
										m);
								break;
							case "w":
								...
								break;
							case "y":
								n = i.prototype.moveYear
										.call(i.prototype, n, m);
								break
							}
						}
						return h(n.getUTCFullYear(), n.getUTCMonth(), n
								.getUTCDate(), n.getUTCHours(), n
								.getUTCMinutes(), n.getUTCSeconds(), 0)
					}
					var o = n && n.toString().match(this.nonpunctuation) || [], n = new Date(
							0, 0, 0, 0, 0, 0, 0), t = {}, v = [ "hh", "h",
							"ii", "i", "ss", "s", "yyyy", "yy", "M", "MM", "m",
							"mm", "D", "DD", "d", "dd", "H", "HH", "p", "P" ], x = {
						hh : function(B, s) {
						...
						p : function(B, s) {
							return B.setUTCHours(s == 1 ? B.getUTCHours() + 12
									: B.getUTCHours())
						}
					}, l, r, j;
					x.M = x.MM = x.mm = x.m;
					x.dd = x.d;
					x.P = x.p;
					n = h(n.getFullYear(), n.getMonth(), n.getDate(), n
							.getHours(), n.getMinutes(), n.getSeconds());
				...
				formatDate : function(j, o, q, m) {
					...
					if (m == "standard") {
						p = {
							...
							p : (a[q].meridiem.length == 2 ? a[q].meridiem[j
									.getUTCHours() < 12 ? 0 : 1] : ""),
							h : j.getUTCHours(),
							i : j.getUTCMinutes(),
							s : j.getUTCSeconds()
						...
						if (m == "php") {
							p = {
								...
								M : a[q].monthsShort[j.getUTCMonth()],
								n : j.getUTCMonth() + 1,
								t : g.getDaysInMonth(j.getUTCFullYear(), j
										.getUTCMonth()),
								j : j.getUTCDate(),
								...
								S : (j.getUTCDate() % 10 <= a[q].suffix.length ? a[q].suffix[j
										.getUTCDate() % 10 - 1]
										: ""),
								a : (a[q].meridiem.length == 2 ? a[q].meridiem[j
										.getUTCHours() < 12 ? 0 : 1]
										: ""),
								g : (j.getUTCHours() % 12 == 0 ? 12 : j
										.getUTCHours() % 12),
								G : j.getUTCHours(),
								i : j.getUTCMinutes(),
								s : j.getUTCSeconds()
